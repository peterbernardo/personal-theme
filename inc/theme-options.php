...
function twentyeleven_theme_options_init() {
	...
	add_settings_field(
		...
		__( 'Color Scheme' ), // Setting field label
	...
	add_settings_field( 'layout',     __( 'Default Layout' ), 'twentyeleven_settings_field_layout',     'theme_options', 'general' );
}
...
function twentyeleven_layouts() {
	$layout_options = array(
		'content-sidebar' => array(
			...
			'label' => __( 'Content on left' ),
			'thumbnail' => get_template_directory_uri() . '/inc/images/content-sidebar.png',
		),
		'sidebar-content' => array(
			'value' => 'sidebar-content',
			'label' => __( 'Content on right' ),
			'thumbnail' => get_template_directory_uri() . '/inc/images/sidebar-content.png',
		),
		'content' => array(
			'value' => 'content',
			'label' => __( 'One-column, no sidebar' ),
...
function twentyeleven_settings_field_link_color() {
	...
	<br />
	<span><?php printf( __( 'Default color: %s' ), '<span id="default-color">' . twentyeleven_get_default_link_color( $options['color_scheme'] ) . '</span>' ); ?></span>
	<?php
}
...
function twentyeleven_theme_options_render_page() {
	...
	<div class="wrap">
		...
		<h2><?php printf( __( '%s Theme Options' ), $theme_name ); ?></h2>
		<?php settings_errors(); ?>
