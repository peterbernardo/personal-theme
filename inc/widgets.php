...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		$widget_ops = array( 'classname' => 'widget_twentyeleven_ephemera', 'description' => __( 'Use this widget to list your recent Aside, Status, Quote, and Link posts' ) );
		$this->WP_Widget( 'widget_twentyeleven_ephemera', __( 'Twenty Eleven Ephemera' ), $widget_ops );
		...
		if ( $ephemera->have_posts() ) :
			...
			<?php while ( $ephemera->have_posts() ) : $ephemera->the_post(); ?>
				...
				<li class="widget-entry-title">
					<a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php printf( esc_attr__( 'Permalink to %s' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
					<span class="comments-link">
						<?php comments_popup_link( __( '0 <span class="reply">comments &rarr;</span>' ), __( '1 <span class="reply">comment &rarr;</span>' ), __( '% <span class="reply">comments &rarr;</span>' ) ); ?>
					</span>
				</li>
				...
				<li class="widget-entry-title">
					...
					?>
					<a href="<?php echo esc_url( $link_url ); ?>" title="<?php printf( esc_attr__( 'Link to %s' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?>&nbsp;<span>&rarr;</span></a>
					<span class="comments-link">
						<?php comments_popup_link( __( '0 <span class="reply">comments &rarr;</span>' ), __( '1 <span class="reply">comment &rarr;</span>' ), __( '% <span class="reply">comments &rarr;</span>' ) ); ?>
					</span>
				</li>
