					...
					<section class="featured-post <?php echo $feature_class; ?>" id="featured-post-<?php echo $counter_slider; ?>">
						...
						<?php
							...
							if ( has_post_thumbnail() ) {
								...
								?>
								<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_post_thumbnail( $thumbnail_size ); ?></a>
								<?php
							}
						?>
					...
					<?php
				    	...
				    	while ( $featured->have_posts() ) : $featured->the_post();
							...
							if ( 1 == $counter_slider )
								...
								$class = '';
				    	?>
						<li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php printf( esc_attr__( 'Featuring: %s' ), the_title_attribute( 'echo=0' ) ); ?>" <?php echo $class; ?>></a></li>
					<?php endwhile;	?>
					</ul>
				</nav>
					...
					while ( $recent->have_posts() ) : $recent->the_post(); ?>
						...
						<li class="entry-title">
							...
							<span class="comments-link">
								<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply' ) . '</span>', __( '<b>1</b> Reply' ), __( '<b>%</b> Replies' ) ); ?>
							</span>
						</li>
