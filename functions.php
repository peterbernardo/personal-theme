...
function twentyeleven_setup() {
	...
	register_default_headers( array(
		'wheel' => array(
			...
			'description' => __( 'Wheel' )
		),
		'shore' => array(
			'url' => '%s/images/headers/shore.jpg',
			'thumbnail_url' => '%s/images/headers/shore-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Shore' )
		),
		'trolley' => array(
			'url' => '%s/images/headers/trolley.jpg',
			'thumbnail_url' => '%s/images/headers/trolley-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Trolley' )
		),
		'pine-cone' => array(
			'url' => '%s/images/headers/pine-cone.jpg',
			'thumbnail_url' => '%s/images/headers/pine-cone-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Pine Cone' )
		),
		'chessboard' => array(
			'url' => '%s/images/headers/chessboard.jpg',
			'thumbnail_url' => '%s/images/headers/chessboard-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Chessboard' )
		),
		'lanterns' => array(
			'url' => '%s/images/headers/lanterns.jpg',
			'thumbnail_url' => '%s/images/headers/lanterns-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Lanterns' )
		),
		'willow' => array(
			'url' => '%s/images/headers/willow.jpg',
			'thumbnail_url' => '%s/images/headers/willow-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Willow' )
		),
		'hanoi' => array(
			'url' => '%s/images/headers/hanoi.jpg',
			'thumbnail_url' => '%s/images/headers/hanoi-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Hanoi Plant' )
		)
	) );
}
...
function twentyeleven_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Showcase Sidebar' ),
		'id' => 'sidebar-2',
		'description' => __( 'The sidebar for the optional Showcase Template' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
function twentyeleven_content_nav( $nav_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<nav id="<?php echo $nav_id; ?>">
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> More posts' ) ); ?></div>
		</nav><!-- #nav-above -->
	<?php endif;
}
...
function format_icon($format_type){
	switch($format_type){
		...
		case 'image':
		echo "<i class=\"arrow icon-camera-retro\"></i>";
		break;
		case 'aside':
		echo "<i class=\"icon-pencil\"></i>";
		break;
		case 'link':
		echo "<i class=\"arrow icon-external-link\"></i>";
		break;
		case 'quote':
		echo "<i class=\"arrow icon-quote-left\"></i>";
		break;
		case 'status':
		echo "<i class=\"arrow icon-twitter\"></i>";
		break;
		case 'video':
		echo "<i class=\"arrow icon-play-circle\"></i>";
		break;
		default:
		echo "<i class=\"arrow icon-bolt\"></i>";
		break;
